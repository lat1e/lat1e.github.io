...
Back in the late 1950's, a young [coffe](naver.com) devised a very simple algorithm as a foundation to construct a machine that could learn to perform different tasks.
